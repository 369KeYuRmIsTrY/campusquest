...
class _InstructorAssignmentsPageState extends State<InstructorAssignmentsPage> {
                      ...
                      errorText:
                          marksController.text.isNotEmpty &&
                                  (num.tryParse(marksController.text) == null ||
                                      ...
                                      num.parse(marksController.text) >
                                          widget.maxMarks)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CommonAppBar(
        title: 'Grade Assignments - ${widget.title}',
          ...
          _isLoading
              ...
              : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isLate =
                      isPastDue && date != null && date.isAfter(widget.dueDate);
                  final statusText =
                      filePath != null
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text(
                                marks != null ? 'Update Grade' : 'Assign Grade',
                              ),
                            ),
                          ),
                        ],
