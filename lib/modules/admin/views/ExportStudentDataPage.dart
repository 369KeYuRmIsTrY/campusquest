...
class _StudentScreenState extends State<StudentScreen>
  ...
  Future<void> _enrollStudent(int studentId, int semesterId) async {
    try {
      ...
      final enrollments = (coursesResponse as List)
          .map((course) => {
  ...
  void _showAddEditDialog({Map<String, dynamic>? student}) {
    ...
    final nameController =
        TextEditingController(text: isEditing ? student!['name'] : '');
                    ...
                    children: [
                      if (isEditing)
                        TextField(
                          ...
                          enabled: false,
                          decoration:
                              _inputDecoration('Student ID', Icons.person),
                        ),
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        onChanged: (value) => setDialogState(() {
                          ...
                          selectedDeptName = _programs.firstWhere(
                              (p) => p['program_id'] == value)['dept_name'];
                        }),
                        validator: (value) =>
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        decoration:
                            _inputDecoration('Current Semester', Icons.book),
                    ...
                    try {
                      if (isEditing) {
                        ...
                        await _enrollStudent(
                            studentResponse['student_id'], selectedSemesterId!);
                        _showSuccessMessage(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildDetailItem(
                          icon: Icons.phone,
                          title: 'Phone',
                          value: student['users']['phone_number'] ?? 'N/A'),
                      _buildDetailItem(
                          icon: Icons.school,
                          title: 'Program',
                          value: student['program']['program_name'] ?? 'N/A'),
                      _buildDetailItem(
                          icon: Icons.business,
                          title: 'Department',
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          _buildActionButton(
                            ...
                            onTap: () {
                              Navigator.pop(context);
                              final index = _filteredStudents.indexWhere((s) =>
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Chip(
                      label: Text(student['program']['program_name'] ?? 'N/A',
