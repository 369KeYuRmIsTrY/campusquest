...
class _ProgramCoursesScreenState extends State<ProgramCoursesScreen>
  ...
  Future<void> _deleteProgramCourse(
      String programId, String courseId, int index) async {
                    ...
                    return Column(
                      ...
                      children: [
                        DropdownButtonFormField<String>(
                          ...
                          disabledHint:
                              Text(_getProgramName(selectedProgramId ?? '')),
                        ),
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          disabledHint:
                              Text(_getCourseTitle(selectedCourseId ?? '')),
                        ),
                        const SizedBox(height: 16),
                        Container(
                          ...
                          child: SwitchListTile(
                            title: const Text('Is Compulsory',
                        ...
                        TextField(
                          ...
                          decoration: _inputDecoration(
                              'Elective Group ID', Icons.group_work),
                        ),
                        const SizedBox(height: 16),
                        TextField(
                          ...
                          keyboardType: TextInputType.number,
                          decoration: _inputDecoration(
                              'Elective Limit', Icons.format_list_numbered),
                        ),
                      ],
                    );
                  },
                    ...
                    children: [
                      ...
                      if (!programCourse['is_compulsory']) ...[
                        _buildDetailItem(
                            ...
                            value: programCourse['elective_group_id']
                                    ?.toString() ??
                                'N/A'),
                        _buildDetailItem(
  ...
  Widget _buildProgramCourseCard(
      Map<String, dynamic> programCourse, int index) {
    return Hero(
      tag:
                  ...
                  : Scrollbar(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) =>
                            _buildProgramCourseCard(
                                _filteredProgramCourses[index], index),
                      ),
                    ),
            ),
