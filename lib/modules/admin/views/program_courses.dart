...
class _ProgramCoursesScreenState extends State<ProgramCoursesScreen>
  ...
  void _filterProgramCourses() {
    ...
    setState(() {
      ...
      _filteredProgramCourses =
          _programCourses.where((programCourse) {
            final programName =
                _getProgramName(programCourse['program_id']).toLowerCase();
            final courseTitle =
                _getCourseTitle(programCourse['course_id']).toLowerCase();
            final isCompulsory =
                programCourse['is_compulsory'].toString().toLowerCase();
            return programName.contains(query) ||
  ...
  Future<void> _deleteProgramCourse(
    ...
    try {
      ...
      setState(
        () => _filteredProgramCourses.insert(index, deletedProgramCourse),
      );
                    ...
                    return Column(
                      ...
                      children: [
                        DropdownButtonFormField<String>(
                          ...
                          disabledHint: Text(
                            _getProgramName(selectedProgramId ?? ''),
                          ),
                        ),
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          disabledHint: Text(
                            _getCourseTitle(selectedCourseId ?? ''),
                          ),
                        ),
                        const SizedBox(height: 16),
                        Container(
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: () async {
                    ...
                    if (!isCompulsory &&
                      ...
                      _showErrorMessage(
                        'Elective Group ID and Limit are required for electives',
                      );
                      return;
                    }
                            ...
                            children: [
                              ...
                              if (!programCourse['is_compulsory']) ...[
                                _buildDetailItem(
                                  ...
                                  value:
                                      programCourse['elective_group_id']
                                          ?.toString() ??
                                      'N/A',
                                ),
                                _buildDetailItem(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  _buildActionButton(
                                    ...
                                    onTap: () {
                                      Navigator.pop(context);
                                      final index = _filteredProgramCourses
                                          .indexWhere(
                                            (pc) =>
                                                pc['program_id'] ==
                                                    programCourse['program_id'] &&
  ...
  Widget _buildProgramCourseCard(
                    ...
                    _filteredProgramCourses.isEmpty
                        ...
                        : Scrollbar(
                          child: ListView.builder(
                            ...
                            itemBuilder:
                                (context, index) => _buildProgramCourseCard(
                                  _filteredProgramCourses[index],
                                  index,
                                ),
                          ),
                        ),
