...
class _TimetablePageAdminState extends State<TimetablePageAdmin> {
  ...
  Future<bool> _checkOneCoursePerDay(
    ...
    try {
      ...
      final timeSlotIds =
          existingTimetable.map((t) => t['time_slot_id']).toList();
  ...
  Future<bool> _checkClassroomConflict(
    ...
    try {
      ...
      final timeSlotIds =
          classroomBookings.map((t) => t['time_slot_id']).toList();
    ...
    try {
      ...
      for (final course in courses) {
        ...
        if (slotsAssigned < lectureCount) {
          unassignedCourses[course['course_name']] =
              lectureCount - slotsAssigned;
        }
      }
  ...
  Future<void> _exportTimetableToPDF() async {
    ...
    try {
      ...
      final filename =
          'timetable_semester_${_timetable.first['semester_id']}.pdf';
